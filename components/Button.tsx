...
export const Button: React.FC<ButtonProps> = ({ 
    ...
    const variants = {
        ...
        annoying: "bg-pink-500 text-yellow-200 font-comic-sans hover:bg-purple-600 border-4 border-dashed border-yellow-400 transform hover:rotate-2 active:scale-95"
    };
